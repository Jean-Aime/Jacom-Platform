  ...
  return (
    <div className="p-8 space-y-8 max-w-7xl mx-auto w-full bg-white min-h-screen">
      <div className="flex justify-between items-end border-b border-gray-200  pb-6">
        ...
        <button className="bg-primary text-white px-5 py-2 rounded-xl text-sm font-semibold flex items-center gap-2 shadow-lg">
      ...
      <div className="bg-white  rounded-2xl border border-red-100  shadow-sm overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-gray-50 /50 border-b border-red-100 ">
            ...
            {content.length === 0 ? (
              ...
              content.map((post: any, i) => (
                <tr key={i} className="hover:bg-gray-50  transition-colors">
                  ...
                  <td className="px-6 py-4"><span className="text-xs px-2 py-0.5 rounded-full bg-red-100 text-primary font-bold uppercase">{post.type || "Content"}</span></td>
                  <td className="px-6 py-4"><span className="text-xs font-bold text-green-500">Published</span></td>
                  <td className="px-6 py-4"><button className="text-primary hover:underline font-bold">Edit</button></td>
                </tr>
              ))
            )}
          </tbody>
