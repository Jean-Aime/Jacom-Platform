...
export default function VideoMaze() {
  return (
        ...
        <div className="relative bg-gradient-to-br from-gray-300 to-gray-400 rounded-lg overflow-hidden shadow-2xl group cursor-pointer h-96">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/70 backdrop-blur-sm p-6">
            ...
            <p className="text-white text-sm">
              We seek out people and clients who rally the perception of their own limits. Those with the ambition to lead and the courage to reach. Watch the video to learn more.
            </p>
          </div>
        </div>
      </div>
