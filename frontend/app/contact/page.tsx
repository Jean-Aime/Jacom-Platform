...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-red-900 pt-32 pb-64">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-primary uppercase tracking-wider">Ethiopia Regional Hub</span>
                </div>
                <p className="text-sm text-gray-600 mb-3">Strategic operations center for East Africa initiatives in tech and agriculture.</p>
                <a href="#" className="text-primary text-sm font-semibold">Regional Details →</a>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-primary uppercase tracking-wider">Nepal Center</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-5 gap-6">
            {[
              ...
              <button key={cat.label} className="bg-gray-50 hover:bg-red-50 border-2 border-gray-200 hover:border-primary rounded-xl p-6 text-center transition group">
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <form className="flex gap-3 max-w-xl mx-auto">
            <input type="email" placeholder="Enter your email" className="flex-1 px-5 py-3 rounded-lg bg-slate-800 border border-slate-700 text-white placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent" />
            <button className="bg-primary hover:bg-red-700 px-8 py-3 rounded-lg font-semibold transition">Subscribe</button>
          </form>
          
          <div className="flex justify-center gap-4 mt-8">
            <a href="#" className="w-10 h-10 bg-slate-800 hover:bg-primary rounded-full flex items-center justify-center transition">
