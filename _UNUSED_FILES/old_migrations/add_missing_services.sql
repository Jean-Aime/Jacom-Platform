-- Add only missing services (srv10-srv28)
INSERT IGNORE INTO Service (id, name, slug, description, overview, featured, createdAt, updatedAt) VALUES
...
-- Link all services to industries
INSERT IGNORE INTO _IndustryToService (A, B) VALUES 
('ind1', 'srv1'), ('ind1', 'srv4'), ('ind2', 'srv1'), ('ind2', 'srv2'), ('ind3', 'srv3'), ('ind3', 'srv4'),
