      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section className="bg-white  rounded-xl border border-gray-200  p-6 space-y-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-red-50 dark:bg-red-900/20 flex items-center justify-center text-primary">
            ...
            {['English', 'Japanese', 'Amharic', 'Nepali'].map((lang, i) => (
              <div key={i} className="flex items-center justify-between">
                ...
                <label className="relative inline-block w-10 h-5">
                  ...
                  <div className="w-full h-full bg-gray-200  rounded-full peer-checked:bg-primary transition-colors"></div>
        ...
        <section className="lg:col-span-2 bg-white  rounded-xl border border-gray-200  p-6 shadow-sm overflow-hidden">
          ...
          <div className="bg-gray-50  p-5 rounded-xl border border-dashed border-gray-200  flex flex-col justify-center text-center">
            <div className="mb-2">
              <svg className="w-16 h-16 mx-auto text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" /></svg>
            </div>
