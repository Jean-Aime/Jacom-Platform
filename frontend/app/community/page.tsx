          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 bg-blue-50 rounded-lg flex items-center justify-center mb-4">{category.icon}</div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 bg-blue-50 rounded-lg flex items-center justify-center mx-auto mb-3">{toolkit.icon}</div>
