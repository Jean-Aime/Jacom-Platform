            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredIndustries.map((industry) => (
                <a
                  ...
                  className="group bg-white rounded-lg shadow-md overflow-hidden card-hover cursor-scale focus:outline-none focus:ring-2 focus:ring-primary/50"
                >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-gradient-to-r from-primary to-red-600 text-white rounded-2xl p-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="/insights" className="btn-primary cursor-scale bg-white text-primary px-8 py-3 rounded-lg font-semibold">
                Browse Insights
              </a>
