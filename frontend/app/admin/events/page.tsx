              ...
              {events.length === 0 ? (
                ...
                events.map((event) => (
                  <tr key={event.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded uppercase">{event.type}</span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => openModal(event)} className="text-blue-600 hover:bg-blue-50 p-1 rounded-lg mr-2">
