  ...
  return (
    <div className="p-8 space-y-8 max-w-[1400px] mx-auto w-full bg-white min-h-screen">
      <div className="flex justify-between items-end">
        ...
        <button className="bg-primary hover:bg-red-700 text-white px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 transition-all">
          ...
          <div className="h-64 flex items-end justify-between gap-4 px-2">
            {[60, 85, 45, 95, 70, 80].map((h, i) => (
              <div key={i} className="group relative flex-1">
                <div className="bg-primary rounded-t-lg w-full transition-all duration-500" style={{height: `${h}%`}}></div>
              </div>
            ))}
          </div>
          <div className="flex justify-between mt-4 px-2 text-xs font-bold text-gray-400 uppercase tracking-wider">
